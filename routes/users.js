 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/sessions/all', protect, authorize('admin'), getAllSessions);
 ...
 *                 message:
 *                   type: string
 *                   example: "Logged out 3 sessions successfully"
 *       401:
 *         description: Not authorized
 *         content:
 *           application/json:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.delete('/sessions/:sessionId', protect, authorize('admin'), terminateSession);
